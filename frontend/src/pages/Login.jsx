    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-900 px-4 py-12 relative overflow-hidden select-none">
      ...
      <div className="w-full max-w-md space-y-8 z-10">
        <div className="text-center">
          <div className="inline-flex h-12 w-12 bg-brand-600 rounded-2xl items-center justify-center text-white shadow-lg shadow-brand-600/30 mb-4 animate-bounce">
            <Briefcase size={24} />
          </div>
          <h2 className="text-3xl font-extrabold text-white tracking-tight">StaffHub HRMS</h2>
